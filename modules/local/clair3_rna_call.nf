process CLAIR3_RNA_CALL {
    ...
    def uniq_id = UUID.randomUUID().toString()
    ...
    /opt/bin/run_clair3_rna \\
        ...
        $args
    mv $output_dir/output.vcf.gz $output_dir/${uniq_id}.output.vcf.gz
    mv $output_dir/output.vcf.gz.tbi $output_dir/${uniq_id}.output.vcf.gz.tbi
